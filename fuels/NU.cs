...
{
    internal class NU : BaseFuel
    {
        public NU() : base("NU", 100000000, false, "log10(x + 1) * 0.5 * 15", new FunctionType().LOGARITHMIC, "x * 0.5", "x² * 50", 0.0065, 0.02 * 0.5, 2865)
        {
            return;
        }
        ...
        {
            if (!IsFastFlux) return Math.Log10(InFlux + 1) * 0.5 * 15.0;
            return 0;
        }
